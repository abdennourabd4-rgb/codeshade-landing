    ...
    <section className="py-16 md:py-24 bg-[#1e293b] overflow-hidden relative">
      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 relative z-10 text-center">
        ...
        <div className="relative mx-auto max-w-5xl">
          ...
          <div className="rounded-2xl border border-white/10 shadow-2xl bg-white/5 backdrop-blur-sm p-2">
            <img
          ...
          <div className="hidden md:block absolute -left-12 top-1/4 bg-white p-4 rounded-2xl shadow-xl border-l-4 border-green-500 animate-bounce-slow">
          ...
          <div className="hidden md:block absolute -right-8 top-1/3 bg-white p-4 rounded-2xl shadow-xl border-l-4 border-blue-500 animate-bounce-slow delay-700">
          ...
          <div className="hidden md:block absolute -bottom-8 left-1/2 -translate-x-1/2 bg-white p-4 rounded-2xl shadow-xl border-l-4 border-orange-500">
